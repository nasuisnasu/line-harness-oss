...
const menuSections = [
  {
    ...
    items: [
      ...
      // 生徒カルテ。テストも授業記録も提出物も既に画面があるので、ここは**入口**であって
      // それらの置き換えではない。深いところは各画面へリンクで飛ばす。
      { href: '/students', label: '生徒カルテ', icon: 'M12 14l9-5-9-5-9 5 9 5z M12 14l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14z' },
      ...
      { href: '/kpi', label: 'KPI / ファネル', icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z' },
    ],
  },
  {
    label: '配信',
    items: [
      ...
      { href: '/business-calendar', label: '営業カレンダー', icon: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z' },
      ...
      { href: '/vocab', label: '単語テスト', icon: 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253' },
      // 単語・古文単語・熟語・4択・講座は生徒から見て別のテスト（リッチメニューも別枠）。
      // 管理画面も分ける。まとめると「熟語を解いた生徒が4択の画面に出る」ことになる。
      { href: '/kobun', label: '古文単語テスト', icon: 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253' },
      { href: '/idiom', label: '熟語テスト', icon: 'M4 6h16M4 12h10M4 18h7M17 14l2.5 2.5L17 19' },
      { href: '/grammar', label: '4択テスト', icon: 'M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z' },
      { href: '/course-test', label: '文法講座テスト', icon: 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253' },
      // 並び替えテスト。生徒にセットを選ばせないので、管理画面でも「問題集」ではなく
      // プール全体を見る。つまずきは分野ではなく型（A1〜G4）で出す。
      { href: '/bas', label: '並び替えテスト', icon: 'M4 7h6v4H4zM14 7h6v4h-6zM4 15h6v4H4zM14 15h6v4h-6z' },
  ...
  },
  {
    label: '分析',
    items: [
      { href: '/entry-routes', label: '流入経路', icon: 'M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1' },
      ...
      { href: 'https://eijaku-ai.readash-crm.workers.dev/qa/console', label: '質問ダッシュボード', icon: 'M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z', external: true },
    ],
  },
  {
    label: '自動化',
